...
import { MailIcon, Check, X } from "lucide-react"
            ...
            <Card key={invitation.id} className="overflow-hidden">
              ...
              <CardHeader className="pb-2">
                <div className="flex items-center justify-between">
                  <div>
                    <h3 className="text-lg font-semibold">{invitation.group.name}</h3>
                    <p className="text-sm text-muted-foreground">Invited by {invitation.inviter.name}</p>
                  </div>
                  <div className="flex gap-2">
                    <Button
                      ...
                      onClick={() => handleReject(invitation.id, invitation.group.name)}
                    >
                      <X className="h-4 w-4" />
                    </Button>
                    <Button
